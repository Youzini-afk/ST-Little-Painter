...
export function buildTaggerPrompt({ context, settings, promptHints } = {}) {
  const schemaHint = {
    ...
    insertionPlan: {
      ...
      fallback: 'after_message',
      display: { mode: 'block', align: 'center', size: 'medium' },
      reason: '',
    },
    warnings: [],
    dropped: [],
  ...
  return [
    {
      ...
      content: [
        ...
        'For insertionPlan, choose where the generated image should render in chat without editing message text. If anchoring to text, return the exact original text substring in anchorQuote and do not return offsets or character indexes.',

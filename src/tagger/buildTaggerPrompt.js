  ...
  return [
    {
      ...
      content: [
        ...
        'For insertionPlan, return only anchorQuote and position. position must be before_anchor or after_anchor; before/after aliases are acceptable but before_anchor/after_anchor are preferred.',
        'anchorQuote must be a short exact original text substring from the latest AI message. Do not include target message fields, fallback behavior, display settings, offsets, or character indexes; the plugin controls those programmatically.',
